...
; (function ($, window, document, undefined) {
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            label: M!="undefined"?'<span class="material-icons md-19">ondemand_video</span>':'<span class="fab fa-youtube"></span>',
...
; (function ($, window, document, Util, undefined) {
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            label: M!="undefined"?'<span class="material-icons md-19">camera_enhance</span>':'<span class="fa fa-camera"></span>',
            deleteMethod: 'POST',
...
;(function ($, window, document, undefined) {
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            label: M!="undefined"?'<span class="material-icons md-19">add_box</span>':'<span class="fa fa-plus-circle"></span>'
        };
    ...
    CustomAddon.prototype.events = function () {
        this.$el
            .on('click', '.medium-insert-images img', $.proxy(this, 'add'));
    };
    ...
    CustomAddon.prototype.backwardsCompatibility = function () {
        this.$el.find('.mediumInsert')
            .removeClass('mediumInsert')
            .addClass('medium-insert-custom');
    ...
    function showPage(page_no) {
            ...
            __PDF_DOC.getPage(page_no).then(function(page){
                ...
                var scale_required = $('#pdf-canvas').get(0).width / page.getViewport(1).width;
                var renderContext = {
    ...
    function showPDF(pdf_url){
        PDFJS.getDocument({url:pdf_url}).then(function(pdf_doc){
            ...
            __PDF_DOC = pdf_doc;
            $(".medium-insert-active").append('<div id="pdf-main-container"><div id="pdf-contents"><div id="pdf-meta"><div id="pdf-buttons"><button id="pdf-prev">Previous</button><button id="pdf-next">Next</button></div><div id="page-count-container">Page <div id="pdf-current-page"></div> of <div id="pdf-total-pages"></div></div></div><canvas id="pdf-canvas" width="400" height="500"></canvas></div></div>');
    ...
    $selectFile.change(function () {
        ...
        if (acceptedTypes[this.files[0].type]) {
